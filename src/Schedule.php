...
class Schedule
{
     ...
     * @param callable $handler function(Exception $e): void
     */
    ...
    /**
     * Добавляет задачу, которая будет выполняться каждый месяц.
     *
    ...
    /**
     * Добавляет задачу с проверкой cron-выражения.
     */
    ...
    /**
     * Получает список задач, которые должны выполниться сейчас.
     */
